<template>
    <div class=" absolute menu z-40 left-0 min-w-52 h-screen top-0" style="background:#0c0e0c; filter: drop-shadow(3px 20px 10px rgba(0, 0, 0, 0.1)); box-shadow: 5px 0px 10px;">
...
<script>
import { HomeIcon, AdjustmentsHorizontalIcon, CurrencyDollarIcon, ListBulletIcon, WrenchIcon, LinkIcon, QuestionMarkCircleIcon} from "@heroicons/vue/24/solid"
 

export default {
  name: 'Nav-bar',
  components: { HomeIcon, AdjustmentsHorizontalIcon, CurrencyDollarIcon, ListBulletIcon, WrenchIcon,LinkIcon, QuestionMarkCircleIcon },
